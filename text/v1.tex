...
In einem Schaltbild werden die Verbindung zwischen den Bauelementen als idea angenommen. (Länge und Leistungsführung spielt keine Rolle)\\
\begin{figure}[h!]
  \begin{center}
    \begin{circuitikz}[european]
...
\begin{figure}[h!]
  \begin{center}
    \begin{circuitikz}[european]
      \draw (0,0)
      to[battery1=$U_B 1V$] (0,2) % The voltage source
      to[short] (1,2)
      to[voltmeter](4,2)
      to[R={$R_1 1k\Omega$}] (4,0) % The resistor
      to[short] (0,0);
     \end{circuitikz}
  \end{center}
\end{figure}
